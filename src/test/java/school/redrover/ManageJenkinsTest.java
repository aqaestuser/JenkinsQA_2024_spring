...
public class ManageJenkinsTest extends BaseTest {
    ...
    public void testSectionNamesOfSecurityBlock() {
        ...
        List<String> actualSecurityBlockList = new HomePage(getDriver())
                .clickManageJenkins()
                .getSecurityBlockElementList();

        Assert.assertEquals(actualSecurityBlockList, expectedSecurityBlockList);
    }
    ...
    public void testSectionDescriptionOfSecurityBlock() {
        ...
        List<String> actualDescriptionList = new HomePage(getDriver())
                .clickManageJenkins()
                .getSecurityBlockDescriptionList();

        Assert.assertEquals(actualDescriptionList, expectedDescriptionList);
    }
    ...
    public void testListOfManageJenkinsLinks() {
        ...
        List<String> actualLinkNameList = new HomePage(getDriver())
                .clickManageJenkins()
                .getListOfManageJenkinsLinks();

        Assert.assertEquals(actualLinkNameList,expectedLinkNameList);
    }
